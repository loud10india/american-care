export const blogs1 = [
    {
        id: 1,
        delay: "0.1s",
        imgSrc: "/assets/images/blog/education.jpg",
        title: "Empowering Education: Enhancing Government Schools",
        text: "One of our primary initiatives involves providing financial support to government schools in these villages. By allocating funds, we empower these educational institutions to enhance their facilities, particularly in the crucial area of access to clean drinking water. This not only ensures a healthier learning environment for the children but also contributes to the overall well-being of the community.",
    },
    {
        id: 2,
        delay: "0.2s",
        imgSrc: "/assets/images/blog/medical-camps.jpg",
        title: "Healthier Lives: Organizing Health Care Camps",
        text: "In addition to our commitment to education, we organize Health Care camps to address the pressing medical needs of the villagers. These camps bring essential healthcare services directly to the doorstep of those who need it the most. By providing medical attention and resources, we strive to improve the health outcomes of individuals and promote a culture of well-being within the community.",
    },
    {
        id: 3,
        delay: "0.3s",
        imgSrc: "/assets/images/blog/bhoomi-pujan-for-community-hall.jpg",
        title: "Unity in Community: Building a Community Hall",
        text: "Recognizing the significance of communal spaces, we are proud to announce the construction of a Community Hall for the villagers. This multipurpose facility will serve as a hub for various social and cultural activities, fostering a sense of unity and shared purpose among the residents.",
    },
];
