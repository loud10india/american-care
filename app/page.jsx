...
export const metadata = {
    title: "Home 1 Main Demo Onepage || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                ...
                <div className='page' id='top'>
                    ...
                    <main id='main'>
                        <ParallaxContainer
                            ...
                            style={{
                                backgroundImage: "url(/assets/images/full-width-images/banner1.jpg)",
                            }}
                            id='home'
                        >
                            <Hero1 />
